...
namespace sp_Medical_group.Web.Api.Contexts
{
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Clinica>(entity =>
            {
                entity.HasKey(e => e.IdClinica)
                    .HasName("PK__clinica__C73A60555E793891");

                entity.ToTable("clinica");

                entity.HasIndex(e => e.Endereco, "UQ__clinica__9456D40629D20E29")
                    .IsUnique();

                entity.HasIndex(e => e.RazaoSocial, "UQ__clinica__9BF93A3071339DEF")
                    .IsUnique();

                entity.HasIndex(e => e.Cnpj, "UQ__clinica__AA57D6B415B43B6F")
                    .IsUnique();
            ...
            modelBuilder.Entity<Consultum>(entity =>
            {
                entity.HasKey(e => e.IdConsulta)
                    .HasName("PK__consulta__CA9C61F59B42269D");
                ...
                entity.HasOne(d => d.IdMedicoNavigation)
                    ...
                    .HasConstraintName("FK__consulta__idMedi__5FB337D6");

                entity.HasOne(d => d.IdPacienteNavigation)
                    .WithMany(p => p.Consulta)
                    .HasForeignKey(d => d.IdPaciente)
                    .HasConstraintName("FK__consulta__idPaci__5EBF139D");
            ...
            modelBuilder.Entity<Especializacao>(entity =>
            {
                entity.HasKey(e => e.IdEspecializacao)
                    .HasName("PK__especial__FC35476CEA338311");

                entity.ToTable("especializacao");

                entity.HasIndex(e => e.TipoEspecializacao, "UQ__especial__9600C0D4ADCA3EB8")
                    .IsUnique();
            ...
            modelBuilder.Entity<ImagemUsuario>(entity =>
            {
                ...
                entity.HasIndex(e => e.IdUsuario, "UQ__imagemUs__645723A7E19E86E3")
                    .IsUnique();
                ...
                entity.HasOne(d => d.IdUsuarioNavigation)
                    ...
                    .HasConstraintName("FK__imagemUsu__idUsu__5812160E");
            });

            modelBuilder.Entity<Medico>(entity =>
            {
                entity.HasKey(e => e.IdMedico)
                    .HasName("PK__medico__4E03DEBAC90B5360");

                entity.ToTable("medico");

                entity.HasIndex(e => e.Crm, "UQ__medico__C1F887FFB92DF284")
                    .IsUnique();
                ...
                entity.HasOne(d => d.IdClinicaNavigation)
                    ...
                    .HasConstraintName("FK__medico__idClinic__4BAC3F29");

                entity.HasOne(d => d.IdEspecializacaoNavigation)
                    .WithMany(p => p.Medicos)
                    .HasForeignKey(d => d.IdEspecializacao)
                    .HasConstraintName("FK__medico__idEspeci__4AB81AF0");

                entity.HasOne(d => d.IdUsuarioNavigation)
                    .WithMany(p => p.Medicos)
                    .HasForeignKey(d => d.IdUsuario)
                    .HasConstraintName("FK__medico__idUsuari__49C3F6B7");
            });

            modelBuilder.Entity<Paciente>(entity =>
            {
                entity.HasKey(e => e.IdPaciente)
                    .HasName("PK__paciente__F48A08F2C9D1C46B");

                entity.ToTable("paciente");

                entity.HasIndex(e => e.Rg, "UQ__paciente__321537C83585A73C")
                    .IsUnique();
            ...
            modelBuilder.Entity<Situacao>(entity =>
            {
                entity.HasKey(e => e.IdSituacao)
                    .HasName("PK__situacao__12AFD197B5888350");
            ...
            modelBuilder.Entity<TipoUsuario>(entity =>
            {
                entity.HasKey(e => e.IdTipousuario)
                    .HasName("PK__tipoUsua__4B78286B81E64BE7");

                entity.ToTable("tipoUsuario");

                entity.HasIndex(e => e.TituloTipoUsuario, "UQ__tipoUsua__C6B29FC3BA68368F")
                    .IsUnique();
            ...
            modelBuilder.Entity<Usuario>(entity =>
            {
                entity.HasKey(e => e.IdUsuario)
                    .HasName("PK__usuario__645723A66DB6C56C");

                entity.ToTable("usuario");

                entity.HasIndex(e => e.Email, "UQ__usuario__AB6E6164E033133B")
                    .IsUnique();
